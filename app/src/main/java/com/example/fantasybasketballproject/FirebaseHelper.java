...
public class FirebaseHelper {
    ...
    // private ArrayList<Player> myItems = new ArrayList<>();

    private FirebaseFirestore db;
    private ArrayList<Player> myMemories;
    // will refer to all Player objects for authorized user
    ...
    public void attachReadDataToUser() {
        ...
        if (mAuth.getCurrentUser() != null) {
            ...
            readData(new FirestoreCallback() {
                @Override
                public void onCallback(ArrayList<Player> PlayerList) {
                    Log.d(TAG, "Inside attachReadDataToUser, onCallback " + PlayerList.toString());
                }
            });
        }
        else {
    ...
    public void addData(Player m) {
        // add Player m to the database
    ...
    private void addData(Player m, FirestoreCallback firestoreCallback) {
        db.collection("users").document(uid).collection("myPlayerList")
                .add(m)
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    @Override
                    public void onSuccess(DocumentReference documentReference) {
                        // This will set the docID key for the Player that was just added.
                        db.collection("users").document(uid).collection("myPlayerList").
    ...
    */
    ...
    public interface FirestoreCallback {
        void onCallback(ArrayList<Player> myList);
    }
